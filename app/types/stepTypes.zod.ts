...
const StartStepKindSchema = z.union([
  z.literal('reading-start'),
  z.literal('listening-start'),
  z.literal('writing-start'),
  z.literal('speaking-start'),
  z.literal('speaking-question-list-start'),
]);

const SpeakingStepKindSchema = z.literal('speaking-question');

export const StepSchema = z.union([
  z.object({ id: z.number(), kind: z.literal('reading-question'), title: z.string(), sentence: z.string(), options: z.array(IdValueSchema) }),
  z.object({
      id: z.number(),
