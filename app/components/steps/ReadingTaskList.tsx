      ...
      <div className="bg-white rounded-lg shadow-lg text-left">
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">
            Read the magazine article about an underground market and answer the best answer for
            each question.
          </h2>
                ...
                {currentQuestion.options.map((option, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-gray-900 text-sm leading-relaxed">{option.value}</span>
                    </label>
                  );
                })}
              </div>
