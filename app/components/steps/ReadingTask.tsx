      ...
      <div className="bg-white rounded-lg shadow-lg max-w-lg w-full p-8">
        ...
        <div className="mb-8">
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <p className="text-gray-900 text-center leading-relaxed">{sentence}</p>
          </div>
          ...
          <div className="space-y-3" role="radiogroup" aria-labelledby="question-text">
            {options?.map((option, index) => (
              ...
              >
                ...
                <span id={`option-${index}-label`} className="text-gray-900 font-medium">
                  {option.value}
                </span>
              </label>
            ))}
        ...
        <div id="question-text" className="sr-only">
          Question {questionNumber} of {totalQuestions}: Complete the sentence by choosing the best
          option
        </div>
