      ...
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-4">
            {kind.includes('reading') && (
              <BookOpenIcon className="w-8 h-8 text-blue-500" aria-hidden="true" />
            )}
            {kind.includes('writing') && (
              <PencilIcon className="w-8 h-8 text-blue-500" aria-hidden="true" />
            )}
            {kind.includes('speaking') && (
              <MicIcon className="w-8 h-8 text-blue-500" aria-hidden="true" />
            )}
            {kind.includes('listening') && (
              <SpeakerIcon className="w-8 h-8 text-blue-500" aria-hidden="true" />
            )}
          </div>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex items-start">
            ...
            <p className="text-sm text-gray-700">
              The questions in this test may get harder or easier to adapt to your level. Use the
              progress bar to pace yourself so that you have time to answer all the questions.
            </p>
          </div>
          ...
          <div className="flex items-start">
            <div
              ...
              aria-hidden="true"
            ></div>
            <p className="text-sm text-gray-700">You will not lose points for incorrect answers.</p>
          </div>
        ...
        <div id="reading-instructions" className="sr-only">
          ...
          Questions adapt to your level, no points lost for incorrect answers, and submissions
