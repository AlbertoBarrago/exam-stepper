...
export function useStepBody({ current, next }: { current: number; next: () => void }) {
  ...
  switch (step.kind) {
    ...
    case 'reading-complete':
      return { StepComponent: () => <ReadingCompleteStep title={step.title} onNextAction={next} /> };
    ...
    case 'listening-complete':
      return { StepComponent: () => <ListeningCompleteStep title={step.title} onNextAction={next} /> };
    case 'writing-start':
      return { StepComponent: () => (
        <WritingIntroStep
          title={step.title}
    ...
    case 'writing-complete':
      return { StepComponent: () => <WritingCompleteStep title={step.title} onNextAction={next} /> };
    case 'speaking-start':
      return { StepComponent: () => (
        <SpeakingIntroStep
          title={step.title}
